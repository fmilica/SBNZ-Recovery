package com.sbnz.recovery.security;
...
import com.sbnz.recovery.security.auth.RestAuthenticationEntryPoint;
import com.sbnz.recovery.security.auth.TokenAuthenticationFilter;
import com.sbnz.recovery.security.auth.TokenAuthenticationProvider;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	// BCrypt podesen na 12 rundi hesiranja
	@Bean
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.antMatchers("/api/illness").permitAll()
