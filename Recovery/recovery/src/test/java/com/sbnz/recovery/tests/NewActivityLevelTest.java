...
public class NewActivityLevelTest {
	...
	public void DetermineActivityLevelAfterInjuryKidney() throws ParseException {
		...
		Injury injury = new Injury("povreda bubrega", new Date(), "opis", InjuryType.INTERNAL, InjuryBodyPart.KIDNEY);
		injuries.add(injury);
	...
	public void DetermineActivityLevelAfterInjuryLiver() throws ParseException {
		...
		ArrayList<Injury> injuries = new ArrayList<Injury>();
		Injury injury = new Injury("povreda jetre", new Date(), "opis", InjuryType.INTERNAL, InjuryBodyPart.LIVER);
		injuries.add(injury);
	...
	public void DetermineActivityLevelAfterMuscleStrainYoung() throws ParseException {
		...
		ArrayList<Injury> injuries = new ArrayList<Injury>();
		Injury injury = new Injury("istegnuce noge", new Date(), "opis", InjuryType.MUSCLE_STRAIN, InjuryBodyPart.ARM);
		injuries.add(injury);
	...
	public void DetermineActivityLevelAfterLowerBodyFracture() throws ParseException {
		...
		ArrayList<Injury> injuries = new ArrayList<Injury>();
		Injury injury = new Injury("prelom noge", new Date(), "opis", InjuryType.FRACTURE, InjuryBodyPart.LEG);
		injuries.add(injury);
	...
	public void DetermineActivityLevelAfterUpperBodyFractureYoung() throws ParseException {
		...
		ArrayList<Injury> injuries = new ArrayList<Injury>();
		Injury injury = new Injury("prelom ruke", new Date(), "opis", InjuryType.FRACTURE, InjuryBodyPart.ARM);
		injuries.add(injury);
	...
	public void DetermineActivityLevelAfterUpperBodyFractureAndLiverInjury() throws ParseException {
		...
		Injury injury = new Injury("prelom ruke", new Date(), "opis", InjuryType.FRACTURE, InjuryBodyPart.ARM);
		injuries.add(injury);
		Injury liverInjury = new Injury("povreda jetre", new Date(), "opis", InjuryType.INTERNAL, InjuryBodyPart.LIVER);
